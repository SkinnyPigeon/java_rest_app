...
//    private static String url = "https://raw.githubusercontent.com/mobilesiri/JSON-Parsing-in-Android/master/index.html";
    private static String url = "https://wedding--photo-test.herokuapp.com/pictures";
...
//    private static final String TAG_PHONE_HOME = "home";
    ...
    private static final String TAG_MY_ID = "id";
...
//                    R.id.email, R.id.mobile});
            ...
            ListAdapter adapter = new SimpleAdapter(
                    MainActivity.this, studentList,
                    R.layout.list_item, new String[]{TAG_MY_ID, TAG_URL,
                    }, new int[]{R.id.my_id,
                    R.id.url});
...
//                JSONArray students = jsonObj.getJSONArray();
...
//                    String gender = c.getString(TAG_GENDER);
                    ...
                    String my_id = c.getString(TAG_MY_ID);
